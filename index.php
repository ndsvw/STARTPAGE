...
<html>
	...
	<body style="background-color: <?php echo urldecode($user->backcolor); ?>">
		...
		<script>
			...
			{
				?>Create_Box("#main", <?php echo $row->userboxid; ?>, "<?php echo $user->style; ?>", "<?php echo $row->link; ?>", "<?php echo urldecode($row->text); ?>", <?php echo $user->boxsize; ?>, "<?php echo $row->forecolor; ?>", "<?php echo $row->backcolor; ?>", true);<?php
				echo "\n\t\t\t";
			}
			echo "\n";
			?>
